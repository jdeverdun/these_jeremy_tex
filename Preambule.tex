...
\AddToShipoutPicture*{\EtiquetteThese}
  \begin{titlepage}
  \centering
      \includegraphics[width=0.15\textwidth]{Logo_universite_montpellier}
      \hfill
       \includegraphics[width=0.15\textwidth]{logo_intrasense}
      \hfill
       \includegraphics[width=0.15\textwidth]{logo_l2c}
      \hfill
       \includegraphics[width=0.15\textwidth]{logo_i2s}
      \hfill
       \includegraphics[width=0.15\textwidth]{logo-college-docotoral}
      \hfill
      \includegraphics[width=0.15\textwidth]{logo_CHU}\\
    \vspace{1cm}
      {\Large \'{E}cole doctorale I2S}\\
    \vspace{0.5cm}
      {\huge 
    \vspace{0.5cm}
      	TH\`{E}SE}\\
    \vspace{0.5cm}
   		{\bfseries pour obtenir le grade de docteur}\\
    \vspace{0.5cm}
    	{\huge\bfseries \@ecole}\\
    \vspace{0.5cm}
    ...
    \vfill
        ...
        Co-directeurs de thèse : {\bfseries \@encadrant}\\
    \vfill
