...
%%Le transfert d’aimantation correspond à une contamination du signal au voisinage des protons marqués et va avoir pour conséquence de réduire ce signal et donc d’affecter la mesure de débit, mais aussi de complexifier l’acquisition d’images multi-coupes. 
...
\begin{figure}[!t]
\centering
\includegraphics[width=13cm]{5_6_qualite_asl}
