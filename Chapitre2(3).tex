...
\begin{figure}[!t]
\centering
\includegraphics[width=11cm]{1_9_saturation_partielle}
...
\begin{figure}[!t]
\centering
\includegraphics[width=11cm]{1_8_IRM_temps_de_vol}
...
\begin{figure}[!t]
\centering
\includegraphics[width=9cm]{1_12_image_QSM}
