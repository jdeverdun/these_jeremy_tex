...
%\caption{Comparaison des différents modèles en terme de compartiments.}
...
\begin{figure}[!t]
\centering
\includegraphics[width=12cm]{4_11_structure_sujet}
...
\begin{figure}[!t]
\centering
\includegraphics[width=15cm]{4_13_perf_ASL}
...
\begin{figure}[!t]
\centering
\includegraphics[width=15cm]{4_14_elastances_resistances}
...
\begin{figure}[!t]
\centering
\includegraphics[width=15cm]{4_15_evolution_pression}
...
\begin{figure}[!t]
\centering
\includegraphics[width=13cm]{4_27_segmentation}
...
\begin{figure}[!t]
\centering
\includegraphics[width=15cm]{4_19_debit_ventriculaire}
...
\begin{figure}[!t]
\centering
\includegraphics[width=15cm]{4_23_compensation_ACoA}
